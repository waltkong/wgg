define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'web/solution/index' + location.search,
                    add_url: 'web/solution/add',
                    edit_url: 'web/solution/edit',
                    del_url: 'web/solution/del',
                    multi_url: 'web/solution/multi',
                    table: 'web_solution',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'mobile_banner_image', title: '手机banner', events: Table.api.events.image, formatter: Table.api.formatter.image},
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'web/solution/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
